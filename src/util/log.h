...
#define ERROR(...) _smek_error_log(__FILE__, __LINE__, __func__, __VA_ARGS__)
void _smek_error_log(const char *file, u32 line, const char *func, const char *message, ...);

#define WARN(...) _smek_warn_log(__FILE__, __LINE__, __func__, __VA_ARGS__)
void _smek_warn_log(const char *file, u32 line, const char *func, const char *message, ...);

#define LOG(...) _smek_info_log(__FILE__, __LINE__, __func__, __VA_ARGS__)
